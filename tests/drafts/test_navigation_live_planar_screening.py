"""D-101: live Fetch recovery from a floor-level protected corridor object."""
...
def test_real_fetch_detects_and_detours_around_floor_level_protected_object():
    env = gym.make(
    ...
    try:
        ...
        protected.set_pose(sapien.Pose(p=[route_point[0], route_point[1], 0.05]))
