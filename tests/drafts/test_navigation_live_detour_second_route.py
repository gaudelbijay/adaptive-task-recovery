"""D-099: live safety detours generalize to the second Fetch goal route."""
...
def test_real_fetch_detours_on_second_goal_route(route_fraction):
    env = gym.make(
    ...
    try:
        ...
        target = env.unwrapped._get_actor("bowl").pose.sp.p[:2]
        ...
        result = attempt_goal(
            env, env.unwrapped.goal_graph.goals[1], _TRAY_SLOTS[1],
        )
