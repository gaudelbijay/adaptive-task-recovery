...
if __name__ == "__main__":
    install_extensions(); install_protocol_adapter("continuous_geometry_composition_v19", "geometry_training_transitions"); base.VisualAgent = RendererV39CompositionAgent; base.main()
