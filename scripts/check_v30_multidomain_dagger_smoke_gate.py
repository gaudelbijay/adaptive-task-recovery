#!/usr/bin/env python3
"""Fail-closed development allocation gate for V30 multidomain DAgger."""
...
def check(config_path: Path) -> dict:
    ...
    if any(not math.isfinite(value) for value in improvements + candidate_rates):
        raise ValueError("non-finite V30 development statistic")
    ...
    return {
        "schema_version": 1,
        "protocol": "V30 one-seed multidomain DAgger allocation gate",
