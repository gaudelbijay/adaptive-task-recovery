#!/usr/bin/env python3
"""Fail-closed development allocation gate for V31 multicamera DAgger."""
...
def check(config_path: Path) -> dict:
    ...
    if any(not math.isfinite(value) for value in improvements + candidate_rates):
        raise ValueError("non-finite V31 development statistic")
    ...
    return {
        "schema_version": 1,
        "protocol": "V31 one-seed multicamera DAgger allocation gate",
