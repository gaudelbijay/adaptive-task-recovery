#!/usr/bin/env python3
"""Checkpointed RGB PPO with action-conditioned VICReg regularization.
...
prediction plus variance/covariance regularization supplies an anti-collapse
self-supervised representation loss.  Actions use a
