#!/usr/bin/env bash
#SBATCH --job-name=atr-visual-dual-teacher
...
#SBATCH --requeue
#SBATCH --output=results/slurm/visual_dual_teacher_%A_%a.out
#SBATCH --error=results/slurm/visual_dual_teacher_%A_%a.err
...
"${ATR_PYTHON}" scripts/train_visual_recovery_dual_teacher_ppo.py \
