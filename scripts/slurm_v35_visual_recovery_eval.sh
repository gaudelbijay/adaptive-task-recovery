#!/usr/bin/env bash
#SBATCH --job-name=atr-v35-visual-eval
#SBATCH --partition=gpu-l40s
#SBATCH --gres=gpu:l40s:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=02:00:00
#SBATCH --output=results/slurm/v35_visual_eval_%A_%a.out
#SBATCH --error=results/slurm/v35_visual_eval_%A_%a.err
...
for condition in ${ATR_EVAL_CONDITIONS:-nominal intervention}; do
  .venv/bin/python scripts/evaluate_v35_visual_recovery.py \
