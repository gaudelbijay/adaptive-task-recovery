#!/usr/bin/env bash
#SBATCH --job-name=atr-v39-backkey-finetune
#SBATCH --partition=gpu-l40s
#SBATCH --gres=gpu:l40s:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=100G
#SBATCH --time=04:00:00
#SBATCH --output=results/slurm/v39_backkey_finetune_%A_%a.out
#SBATCH --error=results/slurm/v39_backkey_finetune_%A_%a.err
