#!/usr/bin/env python3
"""Fail-closed development allocation gate for V27 robust distillation."""
...
def check(config_path: Path) -> dict:
    ...
    if any(not math.isfinite(value) for value in improvements + candidate_rates):
        raise ValueError("non-finite V27 development statistic")
    ...
    return {
        "schema_version": 1,
        "protocol": "V27 one-seed development allocation gate",
