...
roadmap, and experiment logging; [`README.md`](README.md) indexes them in
reading order. The `ai-notes/` directory tracks live decisions, risks, status,
and work items. The rigorous equations,
