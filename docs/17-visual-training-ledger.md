...
- dual-specialist VICReg V20 trainer: `c53b95845bb597a0bfecc889bf90620eef53ba3cbfb4fc2bfcbdaf6a6d5f875a`
- dual-specialist VICReg V20 config: `33604faeb7769d8b69012804d038e421e5f5d7493c70719825e95c7098e8261c`
- low-variance VICReg V21 config: `4e623c9cda90c4fd494e96516d1d2dfe7214cf44ed79d9b39d902b5f2e1030bb`
...
| Five-seed strict and dual-regime report | five-seed view configs; `strict_removal_integrated_five_seed_comparison_v4.json`; `integrated_regime_five_seed_comparison_v2.json` | — | strict `1139785`; paper table/figure `1139786` | Fully dependency-scheduled | Requires all five seeds and 1,280 held-out episodes in each strict/nominal condition; writes distinct artifacts and never overwrites three-seed aggregates |
...
- Cross-method table job `1139530` has the same primary dependencies and runs
  ...
  manual transcription into the README or manuscript.
...
- Confirmatory gate submission `1139545` was cancelled while dependency-pending
...
- The entire replacement forced-sweeper confirmation chain `1139537`--`1139547`
  ...
  strict/nominal V13 chain `1139772`--`1139786`, whose append configs are
...
- Before V12 or any V15/V16 held-out result existed, the integrated state-
  teacher allocation gate was found to depend on a broad strict table that also
  waited for unrelated V7/V13 visual cohorts. A state-only strict config and
